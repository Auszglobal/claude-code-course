...
26. ✅ **Gemini TL;DR**
27. ✅ **Gemini Cheat Sheets**
28. ✅ **Gemini Prompt Templates**
29. ✅ **跨課程進度卡**
30. ✅ **AI Master 成就**
31. ✅ **推薦引擎** — Welcome 頁顯示個人化建議（confused 複習、下一步、due flashcards） — 完成兩個課程觸發 👑 特殊成就 + 分享按鈕 — Welcome 頁顯示兩個課程嘅進度對比，一撳切換 — 7 categories、33 templates（圖片、影片、Workspace、商業、數據、Maps、API） — 8 phases 快速參考（AI Studio、Imagen、Veo、Workspace、Maps、API） — 37 modules 獨立摘要數據（gemini-tldr-data.js）
