...
28. ✅ **Gemini Prompt Templates** — 7 categories、33 templates（圖片、影片、Workspace、商業、數據、Maps、API） — 8 phases 快速參考（AI Studio、Imagen、Veo、Workspace、Maps、API） — 37 modules 獨立摘要數據（gemini-tldr-data.js）
